...
const Home = () => {
	return (
		<div>
			<Navbar></Navbar>
			<section className="bg-[#d7d7d7] pt-[30px] " >
				<Container>
					<div className="flex justify-between items-center">
            <div className="">
						<div className="title">
							<h4 className="text-[35px] text-black font-bold font-secondary ">Hi, I am</h4>
							<h2 className="tracking-wider font-bold font-primary leading-20 text-black text-[65px] mt-[30px] ">Md. Mahidul Islam</h2>
							<p className="font-secondary mt-3 text-2xl text-[#909090] font-bold">Front-end Developer</p>
						</div>
            ...
            <div className="flex justify-center mt-[63px]">
              <a href="#">
                <p className="overflow-hidden text-sm font-bold  text-black bg-none rounded-2xl py-3 px-[34px] border-x border-x-black relative group hover:text-white z-10  duration-[400ms] ease-in-out">My CV
